...
public class StepService extends Service {
	private static final String TAG = "alcher.marathon.iitg.StepService";
    ...
    public void onCreate() {
        String TAG="STEP_SERVICE ONCREATE";
    ...
    public void onStart(Intent intent, int startId) {
        String TAG="STEP_SERVICE ONSTART";
    ...
    public void onDestroy() {
        String TAG="STEP_SERVICE ONDESTROY";
    ...
    private void showNotification() {
     ...
     //
        Notification.Builder builder = new Notification.Builder(StepService.this);
        ...
        builder.setSmallIcon(R.drawable.ic_notification).setContentTitle(text)
